...
import { CreatorWalletLogicUpgradeableV2 } from "./CreatorWalletLogicUpgradeableV2.sol";
...
contract CreatorWalletV2 is ERC2771ContextUpgradeable, MultisigUpgradeable, CreatorWalletLogicUpgradeableV2 {
    constructor(
        address trustedForwarder_,
        INextMeso nextMeso_,
        ICreatorFactory creatorFactory_
    ) ERC2771ContextUpgradeable(trustedForwarder_) CreatorWalletLogicUpgradeableV2(nextMeso_, creatorFactory_) {
    ...
    /// @notice To use only the functions in CreatorWalletLogicUpgradeableV2, only allow transactions to be sent to the self address.
