...
library ReceiptQueue {
     ...
     */
    function dequeue(TeleporterMessageReceiptQueue storage queue) internal returns (TeleporterMessageReceipt memory) {
    ...
    ) internal returns (TeleporterMessageReceipt[] memory) {
