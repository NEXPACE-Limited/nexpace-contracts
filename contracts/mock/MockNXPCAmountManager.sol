...
contract MockNXPCAmountManager is INXPCAmountManager, ERC2771Context, NextOwnablePausable {
    ...
    function setMintedAmount(uint256 amount) external whenExecutable {
        _accumulatedMintedAmount = amount;
    }

    function setBurnedAmount(uint256 amount) external whenExecutable {
